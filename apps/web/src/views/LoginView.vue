...
<template>
  ...
  >
    ...
    <KnowledgeGalaxy
      ...
      @controls-done="showGalaxyControls = false"
      @controls-cancel="showGalaxyControls = false"
      :focal="[0.5, 0.5]"
    ...
    <KnowledgeThreads
      ...
      @controls-done="showThreadsControls = false"
      @controls-cancel="showThreadsControls = false"
      :color="[0.55, 0.72, 1.0]"
      :amplitude="2.3"
      :distance="0"
